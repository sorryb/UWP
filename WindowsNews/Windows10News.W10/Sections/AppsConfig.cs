...
{
    public class AppsConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override RssDataConfig Config
        {
            get
            {
                ...
                {
                    Url = new Uri("http://blogs.windows.com/buildingapps/feed/")
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("AppsListPage");
            }
        }
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    NavigationInfo = (item) =>
                    {
                        return NavigationInfo.FromPage("AppsDetailPage", true);
                    }
                };
            }
        }
