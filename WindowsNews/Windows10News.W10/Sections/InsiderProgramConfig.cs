...
{
    public class InsiderProgramConfig : SectionConfigBase<RssDataConfig, RssSchema>
    {
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("InsiderProgramListPage");
            }
        }
