//---------------------------------------------------------------------------
//
// <copyright file="WhatsGoingOnDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class WhatsGoingOnDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public WhatsGoingOnDetailPage()
        {
            this.ViewModel = new DetailViewModel<RssDataConfig, RssSchema>(new WhatsGoingOnConfig());
